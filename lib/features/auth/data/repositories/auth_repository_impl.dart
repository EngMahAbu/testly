...
class AuthRepositoryImpl implements AuthRepository {
  ...
  // TODO: In optimization, The LoginEntity should be renamed correctly to better describe its content and purpose
  @override
  Future<BaseResponse<LoginEntity>> login(LoginRequest request) async {
    ...
    switch (response) {
      case SuccessResponse<LoginResponse>():
        ...
        if (loginData == null) {
          // TODO: In optimization, This message should be extracted as a string for localization and easier manipulation
          return ErrorResponse<LoginEntity>('Login response is empty');
        }

        return SuccessResponse<LoginEntity>(
          LoginEntity(token: loginData.token, user: loginData.user.toEntity()),
        );
