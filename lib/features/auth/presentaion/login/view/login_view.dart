...
import 'package:testly/features/auth/presentaion/login/widgets/dont_have_account.dart';
import 'package:testly/features/auth/presentaion/login/widgets/remember_me_and_forget_password.dart';
      ...
      listener: (context, state) {
        if (state.login!.data != null) {
          ...
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  SecondScreen(email: state.login!.data!.email!),
            ),
          );
