...
class _AuthApiClient implements AuthApiClient {
  ...
  Future<PasswordResetEmailResponse> sendPasswordResetEmail(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(passwordResetEmailRequest.toJson());
    final _options = _setStreamType<PasswordResetEmailResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'auth/forgotPassword',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PasswordResetEmailResponse _value;
    try {
      _value = PasswordResetEmailResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
